 ...
 */
public class MyIsolationForest extends RandomizableClassifier implements TechnicalInformationHandler, Serializable {
  ...
  public static int m_anomaly = 1;
  protected double m_ajust = 0.5;
  ...
  public static void main(String[] args) {
    ...
    runClassifier(new MyIsolationForest(), args);
  }
  ...
  public class Tree implements Serializable {
     ...
     */
    public Tree(Instances data, Random r, int height, int maxHeight) {
     ...
     */
    public double pathLength(Instance inst) {
  ...
  /*public double pathLength(Instance inst,int h) {

      if (m_successors == null) {
        //return c(m_size);/*return c(m_size);
    	  return 1;
      } 
      if (inst.value(m_a) < m_splitPoint) {
        return m_successors[0].pathLength(inst,h+1) + 1.0;
      } else {
        return m_successors[1].pathLength(inst,h+1) + 1.0;
      }
    }
  }*/
  protected static int anomalyIndex(Instances ins){
		int valueCnt[] = {0,0};
	    int temp = 0;
	    int ind = 0;
	    valueCnt[0] = 0;
