...
public class Config{
	...
	public static String data_folder = total_folder + "com_net_bow_arff_selected//CfsSu_BestF//";//"myselect//";//"com_arff//";
	...
	static String[] SearchS = {"LinearForwardSelection","BestFirst"};//"GreedyStepwise","SubsetSizeForwardSelection","GeneticSearch","RaceSearch"
